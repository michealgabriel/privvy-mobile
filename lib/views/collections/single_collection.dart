...
class SingleCollection extends StatefulWidget {
  ...
  const SingleCollection({super.key, required this.images, required this.collectionName});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        backgroundColor: AppThemeConstants.APP_BG_DARK,
        title: Text(widget.collectionName, style: AppThemeConstants.APP_HEADING_TEXT_SMALL,),
            ...
            GridView.count(
              ...
              children: List.generate(widget.images.length, (index) { 
                  return GestureDetector(
                    onTap: () => appNavigate(context, SingleCollectionImage(image: widget.images[index], collectionName: widget.collectionName,)),
                    child: ClipRRect(
