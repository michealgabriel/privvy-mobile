...
class PrivvyCollectionsStack extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const EdgeInsetsGeometry tabletCardPaddings = EdgeInsets.symmetric(vertical: 50, horizontal: 25);
    ...
    return Stack(
      ...
      children: [
        Animate(
          ...
          child: Container(
            padding: Device.screenType == ScreenType.tablet ? tabletCardPaddings : cardPaddings,
            ...
            child: Column(
              ...
              children: [
                const Wrap(
                  ...
                  children: [
                    Text("Your Exclusive", textAlign: TextAlign.start, style: AppThemeConstants.APP_HEADING_TEXT_SMALL,),
                    Text("Collection Awaits", textAlign: TextAlign.start, style: AppThemeConstants.APP_HEADING_TEXT_SMALL,),
                  ],
                ),
                ...
                SizedBox(
                  width: 110,
                  child: AppButtonStandard(buttonText: "Explore", disabled: false, callback: () => handleCollectionsNavigate(), alternateStyling: true,)
                )
              ],
            ),
          ),
            ...
            child: IgnorePointer(
              child: Transform.rotate(
                ...
                child: Image.asset(
                  ...
                  width: Device.screenType == ScreenType.tablet ? tabletShoeImageWH : shoeImageWH, 
                  height: Device.screenType == ScreenType.tablet ? tabletShoeImageWH : shoeImageWH,
                )
              )
            )
          ),
