...
class PrivvyClothStack extends StatefulWidget {
  ...
  const PrivvyClothStack({super.key, required this.inConstruction, required this.callback});
      ...
      children: [
              ...
              child: Row(
                ...
                children: [
                  const Wrap(
                    ...
                    spacing: 5,
                    children: [
                      Text("Privvi-fy Clothes", textAlign: TextAlign.start, style: AppThemeConstants.APP_HEADING_TEXT_SMALL,),
                      Text("Recommend clothing variations", textAlign: TextAlign.start, style: AppThemeConstants.APP_BODY_TEXT_REGULAR,),
                    ],
                  ),
        ...
        Animate(
          ...
          child: Positioned(
            ...
            child: IgnorePointer(
              child: Transform.rotate(angle: 0.01, child: Image.asset("assets/images/cloth.png", width: 270, height: 270,))
            )
          ),
        ),
