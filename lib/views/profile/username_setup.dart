...
class _UsernameSetupState extends State<UsernameSetup> {
  ...
  void initState() {
    super.initState();
    _nicknameController.text = context.read<ProfileProvider>().userNicknameValue;
  }
  ...
  handleFreshTap() async {
    ...
    {
      AppSPHandlers().setStringSP(AppSPHandlers.USER_NICKNAME, _nicknameController.text.trim());
      context.read<ProfileProvider>().setUserNicknameValue(_nicknameController.text.trim());
          ...
          children: [
            ...
            Container(
              ...
              child: Align(
                ...
                child: Text(widget.isFreshSetup ? "One Last Thing!" : "Something Really Cool...", style: AppThemeConstants.APP_HEADING_TEXT,),
              ),
            ),
      
            const Text('What should privvy call you?', style: AppThemeConstants.APP_BODY_TEXT_REGULAR),
            ...
            AppButtonWide(buttonText: 'FRESH', disabled: false, callback: () => handleFreshTap()),
