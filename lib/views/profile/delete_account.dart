...
class _DeleteAccountState extends State<DeleteAccount> {
  ...
  handleDeleteAccount() async {
    if (_reasonController.text.isEmpty) {
      showAppToast(context, "Please enter a reason for deletion",
          isError: true);
      return;
    }
    ...
    try {
      ...
      Navigator.pop(context); // close loader
      showAppToast(context, AppConstants.generalFailedMessageKey,
          isError: true);
    }
  }
        ...
        children: [
          ...
          Container(
            padding: EdgeInsets.symmetric(
                horizontal: AppThemeConstants().APP_BASE_CONTENT_PADDING),
            child: const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SizedBox(
                ...
                // SizedBox(height: 6,),
                Text("Please state your reason for account deletion.",
                    overflow: TextOverflow.clip,
