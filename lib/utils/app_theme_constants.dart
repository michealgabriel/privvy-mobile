...
class AppThemeConstants {
  ...
  // --
  static const APP_BODY_TEXT_SMALL =
      TextStyle(color: APP_BASE_TEXT_COLOR, fontSize: 12);
  static const APP_BODY_TEXT_SMALL_DIM = TextStyle(
      fontFamily: FONT_FAMILY_REGULAR,
      fontSize: 12,
      color: APP_BASE_TEXT_COLOR_DIM);
  static const APP_BODY_TEXT_REGULAR = TextStyle(
      fontFamily: FONT_FAMILY_REGULAR,
      fontSize: 16,
      fontWeight: FontWeight.w500,
      color: APP_BASE_TEXT_COLOR_DIM_2);
  static const APP_BODY_TEXT_MEDIUM = TextStyle(
      fontFamily: FONT_FAMILY_SEMIBOLD,
      fontSize: 14,
      height: 2,
      fontWeight: FontWeight.w500,
      color: APP_BASE_TEXT_COLOR);
  static const APP_BODY_TEXT_MEDIUM_DIM = TextStyle(
      fontFamily: FONT_FAMILY_SEMIBOLD,
      fontSize: 14,
      height: 2,
      fontWeight: FontWeight.w500,
      color: APP_BASE_TEXT_COLOR_DIM);
  static const APP_BODY_TEXT_LARGE = TextStyle(
      fontFamily: FONT_FAMILY_SEMIBOLD,
      fontSize: 20,
      height: 1.5,
      fontWeight: FontWeight.w500,
      color: APP_BASE_TEXT_COLOR);
  static const APP_HEADING_TEXT_SMALL = TextStyle(
      ...
      fontWeight: FontWeight.normal,
      color: APP_BASE_TEXT_COLOR);
  static const APP_HEADING_TEXT_MEDIUM = TextStyle(
      fontFamily: FONT_FAMILY_EXTRABOLD,
      fontSize: 30,
      letterSpacing: 0.3,
      height: 1.5,
      fontWeight: FontWeight.normal,
      color: APP_BASE_TEXT_COLOR);
  static const APP_HEADING_TEXT = TextStyle(
      fontFamily: FONT_FAMILY_EXTRABOLD,
      fontSize: 40,
      height: 1.5,
      fontWeight: FontWeight.w700,
      color: APP_BASE_TEXT_COLOR);
  static const APP_HEADING_TEXT_2 = TextStyle(
      fontFamily: FONT_FAMILY_EXTRABOLD,
      fontSize: 48,
      height: 1.5,
      fontWeight: FontWeight.w700,
      color: APP_BASE_TEXT_COLOR);
  // --
  TextStyle APP_TEXTFIELD_HINT = TextStyle(
      fontFamily: FONT_FAMILY_REGULAR,
      fontSize: 14,
      height: 1.7,
      fontWeight: FontWeight.w400,
      color: const Color(0xffA9A3C6).withOpacity(0.7));
  static const TextStyle APP_TEXTFIELD_HINT_ACCENT_DARK = TextStyle(
      fontFamily: FONT_FAMILY_REGULAR,
      fontSize: 14,
      height: 1.7,
      fontWeight: FontWeight.w400,
      color: Color(0xffF6F6F9));
  static const APP_TEXTFIELD_DARK = TextStyle(
      fontFamily: FONT_FAMILY_REGULAR,
      fontSize: 14,
      fontWeight: FontWeight.w500,
      color: APP_BASE_TEXT_COLOR);
  // --
  static const APP_BOTTOM_NAV_TEXT = TextStyle(
      fontFamily: FONT_FAMILY_REGULAR,
      fontSize: 12,
      height: 2,
      fontWeight: FontWeight.w500,
      color: Color(0xff8D87A6));

  // Button Text Styles
  static const APP_BUTTON_TEXT_REGULAR = TextStyle(
      fontFamily: FONT_FAMILY_SEMIBOLD,
      fontSize: 15,
      fontWeight: FontWeight.w500,
      color: Color(0xffFFFFFF));
  static const APP_BUTTON_TEXT_REGULAR_ALTERNATE = TextStyle(
      fontFamily: FONT_FAMILY_SEMIBOLD,
      fontSize: 15,
      fontWeight: FontWeight.w500,
  ...
  static const ShapeBorder APP_BOTTOM_SHEETS_BORDER = RoundedRectangleBorder(
